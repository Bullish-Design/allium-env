...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/jjxngswsb214vb58qx485jhmilf0kxxy-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/0ip9rfjvbrxhnn4j3ijpn9wjxav2jcs8-devenv-profile" ]
then
  ln -snf /nix/store/0ip9rfjvbrxhnn4j3ijpn9wjxav2jcs8-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
NIX_CFLAGS_COMPILE=' -frandom-seed=zz28i310zm -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include'
...
DEVENV_PROFILE='/nix/store/0ip9rfjvbrxhnn4j3ijpn9wjxav2jcs8-devenv-profile'
...
export NIX_CC
prefix='/nix/store/zz28i310zmfipk1i2b98kp1kqccl43qk-devenv-shell-env'
OLDPWD=''
export OLDPWD
NIX_LDFLAGS='-rpath /nix/store/zz28i310zmfipk1i2b98kp1kqccl43qk-devenv-shell-env/lib '
export NIX_LDFLAGS
patches=''
export patches
...
defaultBuildInputs=''
out='/nix/store/zz28i310zmfipk1i2b98kp1kqccl43qk-devenv-shell-env'
export out
OPTERR='1'
...
exec /tmp/devenv-envOX1TMx/script 