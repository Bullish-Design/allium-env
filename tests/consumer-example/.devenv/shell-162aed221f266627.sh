...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/jjxngswsb214vb58qx485jhmilf0kxxy-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/315738v6xg1d8ms1cjmzi9n8xyhsrj9r-devenv-profile" ]
then
  ln -snf /nix/store/315738v6xg1d8ms1cjmzi9n8xyhsrj9r-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
NIX_LDFLAGS='-rpath /nix/store/3cn4yjysf5d0bw3a3hz06nxqp7rr9p2b-devenv-shell-env/lib '
export NIX_LDFLAGS
NM='nm'
export NM
...
AS='as'
export AS
prefix='/nix/store/3cn4yjysf5d0bw3a3hz06nxqp7rr9p2b-devenv-shell-env'
...
export OBJDUMP
PS4='+ '
out='/nix/store/3cn4yjysf5d0bw3a3hz06nxqp7rr9p2b-devenv-shell-env'
export out
...
NIX_CFLAGS_COMPILE=' -frandom-seed=3cn4yjysf5 -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include -isystem /nix/store/5bs057cgp4nxqff22jg0k1svs121z6a8-bash-interactive-5.3p9-dev/include'
...
exec /tmp/devenv-envC2Fvfx/script 